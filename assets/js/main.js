...
const translations = {
  fr: {
    ...
    'produit.h2': 'Theseus —<br>voir le pipeline avant de le construire',
    'produit.intro': "Les quatre familles d'agents du cabinet ne sont pas une abstraction. Theseus en est la vitrine publique : un atelier visuel où l'on dessine un pipeline en glisser-déposer, où chaque étape est prévisualisée et auditée en continu, puis exportée en livrables prêts pour la production.",
  ...
  en: {
    ...
    'produit.h2': 'Theseus —<br>see the pipeline before you build it',
    'produit.intro': "The firm's four families of agents aren't an abstraction. Theseus is their public showcase: a visual workshop where you design a pipeline by drag-and-drop, preview and continuously audit every step, then export it as production-ready deliverables.",
